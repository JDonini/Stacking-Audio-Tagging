...
results_proba.to_csv(MODEL_2_OUT_SECOND_STAGE + "y_proba_stage_2.csv", index=False)
...
results_pred.to_csv(MODEL_2_OUT_SECOND_STAGE + "y_pred_stage_2.csv", index=False)


if __name__ == '__main__':
    k.clear_session()
    plot_model(model, to_file=MODEL_2_OUT_SECOND_STAGE + 'cnn_model_stage_2.png')
