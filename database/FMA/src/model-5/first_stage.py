...
from model import cnn_cnn_model_5_s1
sys.path.append('src')
...
results_proba.to_csv(MODEL_5_OUT_FIRST_STAGE + "y_proba_stage_1.csv", index=False)
...
results_pred.to_csv(MODEL_5_OUT_FIRST_STAGE + "y_pred_stage_1.csv", index=False)
