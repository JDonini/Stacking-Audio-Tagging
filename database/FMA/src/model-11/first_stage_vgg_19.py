...
callbacks_list = [
    ModelCheckpoint(MODEL_11_WEIGHTS_FINAL + 'weights_first_stage_vgg_19.h5', save_weights_only=True, save_best_only=True),
    ...
    CSVLogger(MODEL_11_OUT_FIRST_STAGE + 'training_vgg_19.csv', append=True, separator=',')
]
...
results.to_csv(MODEL_11_OUT_FIRST_STAGE + "predictions_vgg_19.csv", index=False)
...
if __name__ == '__main__':
    ...
    generate_ranking_loss_graph(history, MODEL_11_OUT_FIRST_STAGE, 'model_ranking_loss_first_stage_vgg_19.png')
