...
def metrics_cnn_sum_stage_1():
    ...
    with open(MODEL_11_OUT_FIRST_STAGE + 'result_sum_late_fusion_stage_1.csv', 'w') as results:
...
def metrics_cnn_prod_stage_1():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_prod_late_fusion_stage_1.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_prod_late_fusion_stage_1.csv", header=0, index_col=0).values
    ...
    with open(MODEL_11_OUT_FIRST_STAGE + 'result_prob_late_fusion_stage_1.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_median_stage_1():
    ...
    with open(MODEL_11_OUT_FIRST_STAGE + 'result_median_late_fusion_stage_1.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_max_stage_1():
    ...
    with open(MODEL_11_OUT_FIRST_STAGE + 'result_max_late_fusion_stage_1.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_sum_stage_2():
    ...
    with open(MODEL_11_OUT_SECOND_STAGE + 'result_sum_late_fusion_stage_2.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_prod_stage_2():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_11_OUT_SECOND_STAGE + "y_pred_role_prod_late_fusion_stage_2.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_11_OUT_SECOND_STAGE + "y_proba_role_prod_late_fusion_stage_2.csv", header=0, index_col=0).values
    ...
    with open(MODEL_11_OUT_SECOND_STAGE + 'result_prob_late_fusion_stage_2.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_median_stage_2():
    ...
    with open(MODEL_11_OUT_SECOND_STAGE + 'result_median_late_fusion_stage_2.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
...
def metrics_cnn_max_stage_2():
    ...
    with open(MODEL_11_OUT_SECOND_STAGE + 'result_max_late_fusion_stage_2.csv', 'w+') as results:
        print('Hamming Loss - {:.4f}'.format(hl_score), file=results)
        print('Accuracy - {:.4f}'.format(acc_score), file=results)
        print('F1 - {:.4f}'.format(fmeasure_score), file=results)
        print('Roc AUC - {:.4f}'.format(roc_score), file=results)
