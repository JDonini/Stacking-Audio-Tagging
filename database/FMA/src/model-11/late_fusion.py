...
def late_fusion_stage_1():
    ...
    predict_stage_1 = predict_stage_1_sum.values
    predict_stage_1 = MinMaxScaler().fit_transform(predict_stage_1)
    df = pd.DataFrame(predict_stage_1, columns=columns[1:])
    df = df.set_index(predict_stage_1_sum.index)
    predict_stage_1_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_sum_late_fusion_stage_1.csv")
    predict_stage_1_sum = (predict_stage_1_sum > 0.5).astype(int)
    predict_stage_1_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_sum_late_fusion_stage_1.csv")
    ...
    # predict_stage_1_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_prod_late_fusion_stage_1.csv")
    # predict_stage_1_prod = (predict_stage_1_prod > 0.5).astype(int)
    # predict_stage_1_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_prod_late_fusion_stage_1.csv")
    ...
    # predict_stage_1_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_median_late_fusion_stage_1.csv")
    # predict_stage_1_median = (predict_stage_1_median > 0.5).astype(int)
    # predict_stage_1_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_median_late_fusion_stage_1.csv")
    ...
    # predict_stage_1_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_max_late_fusion_stage_1.csv")
    # predict_stage_1_max = (predict_stage_1_max > 0.5).astype(int)
    # predict_stage_1_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_max_late_fusion_stage_1.csv")
...
def late_fusion_stage_2():
    ...
    predict_stage_2_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_sum_late_fusion_stage_2.csv")
    predict_stage_2_sum = (predict_stage_2_sum > 0.5).astype(int)
    predict_stage_2_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_sum_late_fusion_stage_2.csv")
    ...
    predict_stage_2_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_prod_late_fusion_stage_2.csv")
    predict_stage_2_prod = (predict_stage_2_prod > 0.5).astype(int)
    predict_stage_2_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_prod_late_fusion_stage_2.csv")
    ...
    predict_stage_2_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_median_late_fusion_stage_2.csv")
    predict_stage_2_median = (predict_stage_2_median > 0.5).astype(int)
    predict_stage_2_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_median_late_fusion_stage_2.csv")
    ...
    predict_stage_2_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_proba_role_max_late_fusion_stage_2.csv")
    predict_stage_2_max = (predict_stage_2_max > 0.5).astype(int)
    predict_stage_2_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "y_pred_role_max_late_fusion_stage_2.csv")
