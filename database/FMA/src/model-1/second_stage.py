...
from config_project import BATCH_SIZE, TARGET_SIZE, LR, NUM_EPOCHS, LR_DECAY, SEED, REDUCE_LR, EARLY_STOPPING
...
if __name__ == '__main__':
    k.clear_session()
    plot_model(model, to_file=MODEL_1_OUT_SECOND_STAGE + 'cnn_model_stage_2.png')
