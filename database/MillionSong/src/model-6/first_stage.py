...
results_proba.to_csv(MODEL_6_OUT_FIRST_STAGE + "y_proba_stage_1.csv", index=False)
...
results_pred.to_csv(MODEL_6_OUT_FIRST_STAGE + "y_pred_stage_1.csv", index=False)


if __name__ == '__main__':
    k.clear_session()
    plot_model(model, to_file=MODEL_6_OUT_FIRST_STAGE + 'cnn_model_stage_1.png')
