...
results_proba.to_csv(MODEL_5_OUT_SECOND_STAGE + "y_proba_stage_2.csv", index=False)
...
results_pred.to_csv(MODEL_5_OUT_SECOND_STAGE + "y_pred_stage_2.csv", index=False)
