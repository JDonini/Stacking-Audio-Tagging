...
model = Sequential()
model.add(ResNet50(weights=None, include_top=False, input_tensor=Input(shape=IMG_SIZE)))
model.add(Flatten())
...
if __name__ == '__main__':
    ...
    generate_ranking_loss_graph(history, MODEL_14_OUT_FIRST_STAGE, 'model_ranking_loss_first_stage_inception_v3.png')
