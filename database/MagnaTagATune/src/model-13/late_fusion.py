...
def late_fusion_stage_1():
    ...
    df_predict_sum_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_proba_role_sum_late_fusion_stage_1.csv")
    df_predict_sum_1 = (predict_stage_1_sum > 0.5).astype(int)
    df_predict_sum_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_pred_role_sum_late_fusion_stage_1.csv")
    ...
    df_predict_prod_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_proba_role_prod_late_fusion_stage_1.csv")
    df_predict_prod_1 = (predict_stage_1_prod > 0.5).astype(int)
    df_predict_prod_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_pred_role_prod_late_fusion_stage_1.csv")
    ...
    df_predict_median_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_proba_role_median_late_fusion_stage_1.csv")
    df_predict_median_1 = (predict_stage_1_median > 0.5).astype(int)
    df_predict_median_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_pred_role_median_late_fusion_stage_1.csv")
    ...
    df_predict_max_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_proba_role_max_late_fusion_stage_1.csv")
    df_predict_max_1 = (predict_stage_1_max > 0.5).astype(int)
    df_predict_max_1.to_csv(MODEL_13_OUT_FIRST_STAGE + "y_pred_role_max_late_fusion_stage_1.csv")
...
def late_fusion_stage_2():
    ...
    df_predict_sum_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_proba_role_sum_late_fusion_stage_2.csv")
    df_predict_sum_2 = (predict_stage_2_sum > 0.5).astype(int)
    df_predict_sum_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_pred_role_sum_late_fusion_stage_2.csv")
    ...
    df_predict_prod_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_proba_role_prod_late_fusion_stage_2.csv")
    df_predict_prod_2 = (predict_stage_2_prod > 0.5).astype(int)
    df_predict_prod_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_pred_role_prod_late_fusion_stage_2.csv")
    ...
    df_predict_median_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_proba_role_median_late_fusion_stage_2.csv")
    df_predict_median_2 = (predict_stage_2_median > 0.5).astype(int)
    df_predict_median_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_pred_role_median_late_fusion_stage_2.csv")
    ...
    df_predict_max_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_proba_role_max_late_fusion_stage_2.csv")
    df_predict_max_2 = (predict_stage_2_max > 0.5).astype(int)
    df_predict_max_2.to_csv(MODEL_13_OUT_SECOND_STAGE + "y_pred_role_max_late_fusion_stage_2.csv")
