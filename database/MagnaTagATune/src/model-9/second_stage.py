...
from generate_structure import AUDIO_STFT_HARMONIC, AUDIO_STFT_PERCUSSIVE, TRAIN_ANNOTATIONS, TEST_ANNOTATIONS, \
 VALIDATION_ANNOTATIONS, MODEL_9_TENSOR, MODEL_9_WEIGHTS_FINAL, MODEL_9_OUT_SECOND_STAGE
...
model.load_weights(MODEL_9_WEIGHTS_FINAL + 'weights_first_stage.h5')
...
results_proba.to_csv(MODEL_9_OUT_SECOND_STAGE + "y_proba_stage_2.csv", index=False)
...
results_pred.to_csv(MODEL_9_OUT_SECOND_STAGE + "y_pred_stage_2.csv", index=False)
