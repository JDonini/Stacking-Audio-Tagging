...
predict_vgg_16_stage_1 = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "predictions_vgg_16.csv", usecols=columns)
...
predict_vgg_16_stage_2 = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "predictions_vgg_16.csv", usecols=columns)
