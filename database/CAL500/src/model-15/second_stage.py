...
from generate_structure import AUDIO_MEL_SPECTROGRAM, AUTOENCODERS_MEL_SPECTROGRAM, TRAIN_ANNOTATIONS, TEST_ANNOTATIONS, VALIDATION_ANNOTATIONS, \
 MODEL_15_TENSOR, MODEL_15_WEIGHTS_FINAL, MODEL_15_WEIGTHS_PER_EPOCHS, MODEL_15_OUT_SECOND_STAGE
...
callbacks_list = [
    ModelCheckpoint(MODEL_15_WEIGTHS_PER_EPOCHS + 'weights_second_stage_{epoch:03d}.h5', save_weights_only=True, save_best_only=True),
...
if __name__ == '__main__':
    ...
    plot_model(model, to_file=MODEL_15_OUT_SECOND_STAGE + 'cnn_model_15_second_stage.png')
