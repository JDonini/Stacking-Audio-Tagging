...
def generate_acc_graph():
    ...
    plt.savefig(MODEL_3_OUT_SECOND_STAGE + 'model_accuracy_second_stage.png')
    plt.close()
...
def generate_loss_graph():
    ...
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    plt.savefig(MODEL_3_OUT_SECOND_STAGE + 'model_loss_second_stage.png')
    plt.close()
...
def generate_auc_graph():
    ...
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    plt.savefig(MODEL_3_OUT_SECOND_STAGE + 'model_auc_second_stage.png')
    plt.close()
