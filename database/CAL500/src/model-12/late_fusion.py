...
def late_fusion_stage_2():
    ...
    predict_stage_2_sum.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_pred_role_sum_late_fusion_stage_2.csv")
    predict_stage_2_sum = (predict_stage_2_sum > 0.5).astype(int)
    predict_stage_2_sum.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_proba_role_sum_late_fusion_stage_2.csv")
    ...
    predict_stage_2_prod.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_pred_role_prod_late_fusion_stage_2.csv")
    predict_stage_2_prod = (predict_stage_2_prod > 0.5).astype(int)
    predict_stage_2_prod.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_proba_role_prod_late_fusion_stage_2.csv")
    ...
    predict_stage_2_median.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_pred_role_median_late_fusion_stage_2.csv")
    predict_stage_2_median = (predict_stage_2_median > 0.5).astype(int)
    predict_stage_2_median.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_proba_role_median_late_fusion_stage_2.csv")
    ...
    predict_stage_2_max.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_pred_role_max_late_fusion_stage_2.csv")
    predict_stage_2_max = (predict_stage_2_max > 0.5).astype(int)
    predict_stage_2_max.to_csv(MODEL_12_OUT_FIRST_STAGE + "y_proba_role_max_late_fusion_stage_2.csv")
