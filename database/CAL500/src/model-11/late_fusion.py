...
def late_fusion_stage_1():
    ...
    predict_stage_1_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_sum_late_fusion_stage_1.csv")
    ...
    predict_stage_1_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_prod_late_fusion_stage_1.csv")
    ...
    predict_stage_1_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_median_late_fusion_stage_1.csv")
    ...
    predict_stage_1_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_max_late_fusion_stage_1.csv")
...
def late_fusion_stage_2():
    ...
    predict_stage_2_sum.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_sum_late_fusion_stage_2.csv")
    ...
    predict_stage_2_prod.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_prod_late_fusion_stage_2.csv")
    ...
    predict_stage_2_median.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_median_late_fusion_stage_2.csv")
    ...
    predict_stage_2_max.to_csv(MODEL_11_OUT_FIRST_STAGE + "role_max_late_fusion_stage_2.csv")
