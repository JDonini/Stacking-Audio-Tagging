...
callbacks_list = [
    ModelCheckpoint(MODEL_11_WEIGHTS_FINAL + 'weights_first_stage_inception_v3.h5', save_weights_only=True, save_best_only=True),
    ...
    CSVLogger(MODEL_11_OUT_FIRST_STAGE + 'training_inception_v3.csv', append=True, separator=',')
]
