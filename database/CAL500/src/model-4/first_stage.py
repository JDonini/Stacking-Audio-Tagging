...
def generate_acc_graph():
    ...
    plt.savefig(MODEL_4_OUT_FIRST_STAGE + 'model_accuracy_first_stage.png')
    plt.close()
...
def generate_loss_graph():
    ...
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    plt.savefig(MODEL_4_OUT_FIRST_STAGE + 'model_loss_first_stage.png')
    plt.close()
...
def generate_auc_graph():
    ...
    plt.xlabel('Epoch')
    plt.legend(['Train', 'Test'], loc='upper left')
    plt.savefig(MODEL_4_OUT_FIRST_STAGE + 'model_auc_first_stage.png')
    plt.close()
