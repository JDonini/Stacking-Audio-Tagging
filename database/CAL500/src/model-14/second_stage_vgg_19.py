...
callbacks_list = [
    ...
    CSVLogger(MODEL_14_OUT_SECOND_STAGE + 'training_vgg_19.csv', append=True, separator=',')
]
...
results_testing.to_csv(MODEL_14_OUT_SECOND_STAGE + "testing_vgg_19.csv", index=False)
...
results.to_csv(MODEL_14_OUT_SECOND_STAGE + "predictions_vgg_19.csv", index=False)


if __name__ == '__main__':
    k.clear_session()
    generate_acc_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_accuracy_second_stage_vgg_19.png')
    generate_loss_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_loss_second_stage_vgg_19.png')
    generate_auc_roc_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_auc_roc_second_stage_vgg_19.png')
    generate_auc_pr_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_auc_pr_second_stage_vgg_19.png')
    generate_hamming_loss_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_hamming_loss_second_stage_vgg_19.png')
    generate_ranking_loss_graph(history, MODEL_14_OUT_SECOND_STAGE, 'model_ranking_loss_second_stage_vgg_19.png')
    plot_model(model, to_file=MODEL_14_OUT_SECOND_STAGE + 'cnn_model_second_stage_vgg_19.png')
