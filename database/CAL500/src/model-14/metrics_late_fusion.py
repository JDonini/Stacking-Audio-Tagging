...
def metrics_cnn_sum_stage_1():
    ...
    y_pred = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_proba_role_sum_late_fusion_stage_1.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_pred_role_sum_late_fusion_stage_1.csv", header=0, index_col=0).values
...
def metrics_cnn_prob_stage_1():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_proba_role_prob_late_fusion_stage_1.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_pred_role_prob_late_fusion_stage_1.csv", header=0, index_col=0).values
...
def metrics_cnn_median_stage_1():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_proba_role_median_late_fusion_stage_1.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_pred_role_median_late_fusion_stage_1.csv", header=0, index_col=0).values
...
def metrics_cnn_max_stage_1():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_proba_role_max_late_fusion_stage_1.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_FIRST_STAGE + "y_pred_role_max_late_fusion_stage_1.csv", header=0, index_col=0).values
...
def metrics_cnn_sum_stage_2():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_proba_role_sum_late_fusion_stage_2.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_pred_role_sum_late_fusion_stage_2.csv", header=0, index_col=0).values
...
def metrics_cnn_prob_stage_2():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_proba_role_prob_late_fusion_stage_2.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_pred_role_prob_late_fusion_stage_2.csv", header=0, index_col=0).values
...
def metrics_cnn_median_stage_2():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_proba_role_median_late_fusion_stage_2.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_pred_role_median_late_fusion_stage_2.csv", header=0, index_col=0).values
...
def metrics_cnn_max_stage_2():
    y_test = pd.read_csv(TEST_ANNOTATIONS, header=0, index_col=0).values
    y_pred = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_proba_role_max_late_fusion_stage_2.csv", header=0, index_col=0).values
    y_proba = pd.read_csv(MODEL_14_OUT_SECOND_STAGE + "y_pred_role_max_late_fusion_stage_2.csv", header=0, index_col=0).values
