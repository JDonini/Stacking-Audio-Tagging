...
if len(k.tensorflow_backend._get_available_gpus()) > 1:
    ...
    model = merge_late_fusion_model_5_stage_1()
...
if __name__ == '__main__':
    ...
    generate_ranking_loss_graph(history, MODEL_5_OUT_FIRST_STAGE, 'model_ranking_loss_second_stage.png')
    plot_model(model, to_file=MODEL_5_OUT_FIRST_STAGE + 'cnn_model_first_stage.png')
