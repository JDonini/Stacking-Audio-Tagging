...
from generate_structure import MODEL_5_OUT_FIRST_STAGE, MODEL_5_OUT_SECOND_STAGE

columns = pd.read_csv(MODEL_5_OUT_FIRST_STAGE + "predictions_vgg_19.csv").columns[1:].tolist()

predict_vgg_19_stage_1 = pd.read_csv(MODEL_5_OUT_FIRST_STAGE + "predictions_vgg_19.csv", usecols=columns)
predict_inception_resnet_v2_stage_1 = pd.read_csv(MODEL_5_OUT_FIRST_STAGE + "predictions_inception_resnet_v2.csv",
                                                  usecols=columns)
predict_inception_v3_stage_1 = pd.read_csv(MODEL_5_OUT_FIRST_STAGE + "predictions_inception_v3.csv", usecols=columns)

predict_vgg_19_stage_2 = pd.read_csv(MODEL_5_OUT_SECOND_STAGE + "predictions_vgg_19.csv", usecols=columns)
predict_inception_resnet_v2_stage_2 = pd.read_csv(MODEL_5_OUT_SECOND_STAGE + "predictions_inception_resnet_v2.csv",
                                                  usecols=columns)
predict_inception_v3_stage_2 = pd.read_csv(MODEL_5_OUT_SECOND_STAGE + "predictions_inception_v3.csv", usecols=columns)
