...
from keras.layers import Dense, Flatten, Dropout, Input, Activation, Reshape
...
sys.path.append('src')
from generate_structure import TRAIN_ANNOTATIONS, TEST_ANNOTATIONS, VALIDATION_ANNOTATIONS, AUDIO_CHROMAGRAM, AUTOENCODERS_CHROMAGRAM
sys.path.append('database')
from config_project import FIG_SIZE, EXT_IMG, SEED, BATCH_SIZE, TARGET_SIZE, NUM_EPOCHS, IMG_SIZE
...
def generate_train_autoencoders():
    print('Generate Autoencoderes - Train')
...
def generate_test_autoencoders():
    print('Generate Autoencoderes - Test')
...
def generate_valid_autoencoders():
    print('Generate Autoencoderes - Validation')
