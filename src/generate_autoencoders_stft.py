...
sys.path.append('src')
from generate_structure import MODEL_AUTOENCODERS, BINARY_ANNOTATIONS, VALIDATION_ANNOTATIONS, AUDIO_STFT, \
 AUTOENCODERS_STFT
...
model = load_model(MODEL_AUTOENCODERS + 'model_stft.h5')
